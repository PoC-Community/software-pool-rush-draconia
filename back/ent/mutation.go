...
func (m *CharacterMutation) SetUserID(id uuid.UUID) {
	m.user = &id
}
...
func (m *CharacterMutation) UserID() (id uuid.UUID, exists bool) {
	if m.user != nil {
		return *m.user, true
	}
	return
...
func (m *CharacterMutation) UserIDs() (ids []uuid.UUID) {
	if id := m.user; id != nil {
		ids = append(ids, *id)
	}
	return
...
func (m *UserMutation) AddCharacterIDs(ids ...uuid.UUID) {
	if m.characters == nil {
...
func (m *UserMutation) RemoveCharacterIDs(ids ...uuid.UUID) {
...
func (m *UserMutation) RemovedCharactersIDs() (ids []uuid.UUID) {
...
func (m *UserMutation) CharactersIDs() (ids []uuid.UUID) {
