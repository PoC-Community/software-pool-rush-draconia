...
func (cq *CharacterQuery) QueryUser() *UserQuery {
...
func (cq *CharacterQuery) WithUser(opts ...func(*UserQuery)) *CharacterQuery {
	query := (&UserClient{config: cq.config}).Query()
...
func (cq *CharacterQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Character, init func(*Character), assign func(*Character, *User)) error {
