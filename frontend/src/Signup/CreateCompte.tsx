...
function SignupCompte({
    ...
    onSucces,
    onError,
}: {name:string, email:string, password:string, confirmation_password:string, onSucces:any, onError:any}) {
...
export default function Connection({
    ...
    password,
    confirmation_password,
}: {name:string, email:string, password:string, confirmation_password:string}) {
